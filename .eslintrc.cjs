module.exports = {
  root: true,
  extends: ['eslint:recommended', 'plugin:node/recommended', 'plugin:@typescript-eslint/eslint-recommended', 'prettier', 'plugin:storybook/recommended'],
  globals: {
    Atomics: 'readonly',
  ...
  settings: {
    ...
    'svelte3/ignore-styles': attrs => attrs.type && attrs.type !== 'text/css' || attrs.lang && attrs.lang !== 'css'
  },
